...
LOAD CSV WITH HEADERS FROM "https://raw.githubusercontent.com/lju-lazarevic/importdata/master/drivers_license.csv" AS row
...
LOAD CSV WITH HEADERS FROM "https://raw.githubusercontent.com/lju-lazarevic/importdata/master/person.csv" AS row
...
CREATE (p)-[:DRIVES]->(v)
REMOVE v.licenseNo;
LOAD CSV WITH HEADERS FROM "https://raw.githubusercontent.com/lju-lazarevic/importdata/master/facebook_event_checkin.csv" AS row
...
LOAD CSV WITH HEADERS FROM "https://raw.githubusercontent.com/lju-lazarevic/importdata/master/get_fit_now_member.csv" AS row
...
LOAD CSV WITH HEADERS FROM "https://raw.githubusercontent.com/lju-lazarevic/importdata/master/get_fit_now_check_in.csv" AS row
...
LOAD CSV WITH HEADERS FROM "https://raw.githubusercontent.com/lju-lazarevic/importdata/master/interview.csv" AS row
